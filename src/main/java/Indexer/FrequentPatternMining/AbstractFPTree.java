package Indexer.FrequentPatternMining;
...
public abstract class AbstractFPTree {
     ...
     * Constructor
     */
    protected AbstractFPTree(Menu menu, TableStats tableBaseProperties, String tableName, AbstractFPTreeNode root) {
        this.menu = menu;
    ...
    private void fpGrowthStep(HashMap<String, LinkedList<AbstractFPTreeNode>> headerTable, String base) {
        ...
        for (String item : headerTable.keySet()) {
            ...
            if (conditionalTree.getChildCount() > 0)
                fpGrowthStep(conditionalHeaderTable, currentPattern);
        }
    }
}
